...
### [10] [McMg: A Learned Phase-Space Multi-channel Multigrid Preconditioner for Helmholtz Equation](https://arxiv.org/abs/2606.30495)
...
### [11] [Gregory Nested Picard Iteration Schemes for Open Quantum Systems Governed by the Lindblad Equation](https://arxiv.org/abs/2606.29002)
...
### [12] [A structure-preserving Chebyshev-filtered subspace iteration for the Bethe-Salpeter eigenvalue problem](https://arxiv.org/abs/2606.29025)
...
### [13] [A Mass, Momentum, and Energy Conserving Semi-Lagrangian Adaptive-Rank (SLAR) Method for the Vlasov-Poisson System](https://arxiv.org/abs/2606.29027)
...
### [14] [Residual-Guided Dictionary Learning for Spectrally Accurate Koopman Approximation](https://arxiv.org/abs/2606.29083)
...
### [15] [Consistent CutPINNs for Convection-Diffusion Equations on Curved Level-Set Domains](https://arxiv.org/abs/2606.29147)
*Maneesh Kumar Singh*
...
### [16] [Second-Order Area/Volume-Preserving PFEMs for Surface Diffusion via Simpson--Boole Geometric Identities](https://arxiv.org/abs/2606.29195)
...
### [17] [A Multi-Level Machine Learning Framework for Inverse Scattering Problems with Multi-Frequency Data](https://arxiv.org/abs/2606.29368)
...
### [18] [Fourier Neural Operators with Least-Squares Readout Refit for Learning Random Obstacle-to-Solution Maps](https://arxiv.org/abs/2606.29436)
...
### [19] [Fundamental weak convergence theorem for stochastic Volterra integral equations and its applications](https://arxiv.org/abs/2606.29458)
...
### [20] [Stable Positive Integral Deferred Correction Methods for Positive Dynamical Systems](https://arxiv.org/abs/2606.29523)
*Pezzella Mario*
...
### [21] [Hypocoercivity-preserving space-time Galerkin methods for kinetic Fokker-Planck equations](https://arxiv.org/abs/2606.29621)
...
### [22] [Fourier--Hankel Moment Methods for Topological Counting and Phase-Center Recovery in Acoustic Inverse Scattering](https://arxiv.org/abs/2606.29678)
...
### [23] [Implementation of Hyperelastic Physics-Augmented Neural Networks in the Explicit Finite Element Codes Simcenter Radioss and OpenRadioss with Applications to Impact Events](https://arxiv.org/abs/2606.29874)
...
### [24] [Dirichlet-Neumann waveform relaxation for heterogeneous heat equations: continuous and time discrete L2 analysis](https://arxiv.org/abs/2606.29987)
...
### [25] [A polynomial moment approach to a rank condition for continuous-stage Runge--Kutta methods](https://arxiv.org/abs/2606.30122)
*Yuto Miyatake*
...
### [26] [Low-Rank Tensor Completion using Tensor Train Decomposition via Riemannian Optimization on the Quotient Geometry](https://arxiv.org/abs/2606.30173)
...
### [27] [On modified anti-Gaussian rules for Jacobi weight functions](https://arxiv.org/abs/2606.30305)
...
### [28] [Adjoint-Based Bayesian Uncertainty Quantification for PDE-Constrained Inverse Problems with Application to Semiconductor Imaging](https://arxiv.org/abs/2606.30340)
...
### [29] [A Quantum Spectral Solver for Periodic Incompressible Stokes Flow](https://arxiv.org/abs/2606.30447)
...
### [30] [Iterated Tikhonov regularization of large linear problems](https://arxiv.org/abs/2606.30448)
...
### [31] [The Position Space Chern Number: A Topological Index for Chiral Magnetic Systems](https://arxiv.org/abs/2606.28549)
*Zachariah Addison*
...
### [32] [TetMaG-Guided Design and Operando Electron Holography Validation of Current-Induced Domain-Wall Motion in 3D Curved and Cornered Fe Nanobridges](https://arxiv.org/abs/2606.28576)
...
### [33] [Voltage-tunable Josephson Junctions on Germanium Quantum Wells with in-situ Aluminum Contacts](https://arxiv.org/abs/2606.28585)
...
### [34] [Graphene as a Tunable Nonradiative Bath for Moiré Excitons](https://arxiv.org/abs/2606.28591)
...
### [35] [Direct observation of interfacial exchange coupling in a magnetic tunnel junction through spin-polarized quasiparticle interference](https://arxiv.org/abs/2606.28686)
...
### [36] [Multi-level π-junction in a proximitized Ge/SiGe quantum dot probed by an on-chip superconducting microwave resonator](https://arxiv.org/abs/2606.28762)
...
### [37] [Inter-band coherence effects in disordered crystals: beyond the non-crossing approximation](https://arxiv.org/abs/2606.28809)
...
### [38] [Topological phase and its effective tuning in a ladder lattice](https://arxiv.org/abs/2606.28816)
*Qi-Bo Zeng*
...
### [39] [Interplay of Electrode Coupling Engineering, Quasiperiodicity, and Magnetic Flux in Quantum Transport through a Su-Schrieffer-Heeger Ring](https://arxiv.org/abs/2606.28846)
...
### [40] [Coherent and Incoherent Interfacial Spin Transport: Quantum-to-Classical Crossover in Spin Superfluids](https://arxiv.org/abs/2606.28877)
...
### [41] [Reproducible Ohmic bismuth contacts to $\textrm{MoS}_2$ nanotubes and nanoribbons](https://arxiv.org/abs/2606.28902)
...
### [42] [Optically Switched Phonon Superradiance of Surface Acoustic Wave in Diamond](https://arxiv.org/abs/2606.28935)
...
### [43] [Synchronic scattering and geometric dephasing in microwave-induced resistance oscillations](https://arxiv.org/abs/2606.28977)
*Jesus Iñarrea*
...
### [44] [Electron Delocalization versus Emission Coherence of Quantum Dot Superlattices](https://arxiv.org/abs/2606.29262)
...
### [45] [Learning Inhomogeneous Heisenberg Hamiltonians in Nanographene Spin Chains](https://arxiv.org/abs/2606.29281)
...
### [46] [Emergent energy scales in magnonic systems with relative motion](https://arxiv.org/abs/2606.29316)
*Daigo Oue*
...
### [47] [Quantum Theory of Current-Generating Local Orbital Magnetization](https://arxiv.org/abs/2606.29330)
*Akito Daido*
...
### [48] [Probing Quantum Geometric Phases via Scanning Tunneling Microscopy](https://arxiv.org/abs/2606.29564)
...
### [49] [Length--Velocity Gauge Equivalence of Quantum Geometric Nonlinear Conductivity](https://arxiv.org/abs/2606.29663)
...
### [50] [Spin-1 Dirac dispersion and Chern insulating phases in 2D honeycomb Sierpiński fractal](https://arxiv.org/abs/2606.29827)
...
### [51] [Hall viscosity from metric-sensitive dichroic probes](https://arxiv.org/abs/2606.30051)
...
### [52] [Perfect elliptic dichroism: Probing the metric of anisotropic quantum Hall droplets](https://arxiv.org/abs/2606.30052)
...
### [53] [Anomalous Duffing mechanics of a suspended carbon nanotube quantum dot at ultrastrong coupling](https://arxiv.org/abs/2606.30099)
...
### [54] [Rolling Two-Dimensional Collinear Magnets into Chiral Nanotubes with $p$-Wave Magnetism](https://arxiv.org/abs/2606.30214)
...
### [55] [Topological control of third-harmonic generation in a mesoscopic quantum ring with spiral dislocation](https://arxiv.org/abs/2606.30245)
...
### [56] [Heat rectification through a quantum two-level system](https://arxiv.org/abs/2606.30465)
...
### [57] [Transport in extended Kitaev chain with time reversal symmetry breaking and long-range interaction](https://arxiv.org/abs/2606.30483)
...
### [58] [GaAs/AlAs Acoustic Nanocavities for Coherent GHz-THz Phonon Engineering](https://arxiv.org/abs/2606.30510)
...
### [59] [Microfabricated Au and Au/graphene bilayer platelets for levitation experiments](https://arxiv.org/abs/2606.30591)
...
### [60] [Improved Scaling for Fast Mode of Ozaki Scheme II](https://arxiv.org/abs/2606.29129)
...
### [61] [The BEG model at the FAD triple point on the square lattice](https://arxiv.org/abs/2606.28821)
...
### [62] [Metric Congruence in Finite-Dimensional Non-Hermitian Quantum Mechanics](https://arxiv.org/abs/2606.28868)
...
### [63] [How to Untwist Twisted Gauge Fields](https://arxiv.org/abs/2606.28888)
...
### [64] [The heat-kernel master field on $\mathbb{Z}^d$ at strong coupling](https://arxiv.org/abs/2606.28945)
*Thibaut Lemoine*
...
### [65] [Cohomological beta function](https://arxiv.org/abs/2606.28975)
...
### [66] [A Unified Geometric Framework for BPS Flows: Split Attractor, Hessian, and Spectral Networks](https://arxiv.org/abs/2606.29190)
*Qiang Wang*
...
### [67] [Probability density functions as solutions of heterogeneous Cattaneo-Vernotte diffusion equation](https://arxiv.org/abs/2606.29234)
...
### [68] [PDE-constrained optimization for virtual sensing in structural dynamics: Full-field displacement and force recovery from sparse sensors](https://arxiv.org/abs/2606.29349)
...
### [69] [A Multi-Body Dobrushin-Sokal Criterion -- Part II](https://arxiv.org/abs/2606.29404)
*Jan Philipp Neumann*
...
### [70] [Existence and absence of Bose-Einstein condensation in the interacting random Kac-Luttinger model](https://arxiv.org/abs/2606.30277)
...
### [71] [Generalized Hermite Polynomials and Spectral Degeneracies of a Singular Sextic Oscillator](https://arxiv.org/abs/2606.30357)
...
### [72] [A Kac system interacting with two heat reservoirs: the shearing case](https://arxiv.org/abs/2606.30529)
