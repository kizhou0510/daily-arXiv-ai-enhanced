...
### [1] [Tuning Boron-Vacancy Qubit Coherence through Layer Number in hBN](https://arxiv.org/abs/2609.01812)
...
### [2] [Magnons in Metallic Altermagnetic $\text{KV}_2\text{Se}_2\text{O}$](https://arxiv.org/abs/2609.01853)
...
### [3] [Complete Topological Classification with P and T Symmetries: Revealing a Topological Invariant Invisible to K-Theory](https://arxiv.org/abs/2609.02025)
*Chen Zhang,Y. X. Zhao*
...
### [4] [Persistence and emergence of quantum defects through pressure-induced phase changes](https://arxiv.org/abs/2609.02100)
...
### [5] [In silico design of magnonic lasing in constricted waveguides](https://arxiv.org/abs/2609.02338)
...
### [6] [Room-temperature local strain control of moiré excitons in MoS$_2$/WSe$_2$ heterobilayers](https://arxiv.org/abs/2609.02340)
...
### [7] [Direct observation of flat bands in near-magic-angle twisted bilayer CVD graphene](https://arxiv.org/abs/2609.02403)
...
### [8] [Relaxation effects on Hartree-Fock ground states in twisted bilayer graphene at even integer fillings](https://arxiv.org/abs/2609.02815)
...
### [9] [Rank-Selective Optical Tomography of Higher-Wave Altermagnetism](https://arxiv.org/abs/2609.02429)
...
### [10] [Direct Observation of the Zigzag Edge States of a Supramolecular Diatomic Kagome Lattice](https://arxiv.org/abs/2609.02567)
...
### [11] [Nonreciprocal Magnon Hanle Effect in Antiferromagnetic $α$-Fe$_2$O$_3$](https://arxiv.org/abs/2609.02631)
...
### [12] [Twist as a Mechanical Switch for Reconfigurable Stacking in h-BN](https://arxiv.org/abs/2609.02723)
...
### [13] [QArray+: A physics-informed GPU-accelerated simulator for quantum dot arrays](https://arxiv.org/abs/2609.02736)
...
### [14] [Emergence of the magnetic octupole Rashba-Edelstein effect from spin-orbit entanglement](https://arxiv.org/abs/2609.02768)
...
### [15] [GRADSOLVE: fast exact gradients for ODE ensembles on GPUs](https://arxiv.org/abs/2609.02876)
...
### [16] [Extended Body Propagators](https://arxiv.org/abs/2609.01829)
*Rory O'Dwyer*
...
### [17] [Applying the convolution theorem to the two-dimensional magnetic inverse problem](https://arxiv.org/abs/2609.01862)
*Michael T. M. Woodley*
...
### [18] [Fractional oscillators with fractional damping in the presence of external forces](https://arxiv.org/abs/2609.01883)
...
### [19] [On the Convergence of Metadynamics with Gaussian Hills](https://arxiv.org/abs/2609.01934)
...
### [20] [Superintegrability of stratified symplectic spaces](https://arxiv.org/abs/2609.01953)
...
### [21] [Heat transfer problem of a dense gas described by the Enskog equation with a modification of the Enskog factor](https://arxiv.org/abs/2609.02276)
...
### [22] [Precise spectral asymptotics, exponential localization, and spectral gap estimates for the three-boson lattice Schrödinger operator](https://arxiv.org/abs/2609.02488)
...
### [23] [Bimaterial Eshelby's inclusion problem for polyhedra](https://arxiv.org/abs/2609.02539)
...
### [24] [Ruelle--Pollicott Theory for Metastable Systems: A Unified Framework for Tipping Transitions](https://arxiv.org/abs/2609.02614)
...
### [25] [Asymptotic long-range order for the XY-model on random geometric graphs](https://arxiv.org/abs/2609.02618)
...
### [26] [A Double-Adaptivity Solver for Parabolic PDEs](https://arxiv.org/abs/2609.01748)
...
### [27] [Bounds-Constrained Finite Element Approximation of Time-Dependent Partial Differential Equations](https://arxiv.org/abs/2609.01915)
...
### [28] [Two Adjoint Perspectives on Fokker-Planck Optimization: A Microscopic-Macroscopic Correspondence](https://arxiv.org/abs/2609.02072)
...
### [29] [Error estimate of the nonuniform BDF3-L2 method for subdiffusion equations via multiscale solution decomposition](https://arxiv.org/abs/2609.02178)
...
### [30] [Scattered data interpolation on the torus by compactly supported multinode Shepard operators](https://arxiv.org/abs/2609.02259)
...
### [31] [A Stream-Function Formulation for the Surface Stokes-Helfrich Model - Surface Finite Element Discretization and Validation](https://arxiv.org/abs/2609.02347)
...
### [32] [A Multiscale Finite Element Method for reaction-diffusion eigenproblems arising from neutronics](https://arxiv.org/abs/2609.02420)
...
### [33] [Geometry-dependent rank defect in $C^1$ cubic spline space](https://arxiv.org/abs/2609.02424)
...
### [34] [Numerical Analysis of the Virtual Element Approximation for the Smagorinsky Turbulence Model](https://arxiv.org/abs/2609.02433)
...
### [35] [Reduced order model for parametric Boltzmann equation and its application to inverse problems](https://arxiv.org/abs/2609.02578)
...
### [36] [Computational study of Proper Orthogonal Decomposition methods for parametric approximations](https://arxiv.org/abs/2609.02583)
...
### [37] [Positivity loss in bandlimited spectral reproduction on spheres](https://arxiv.org/abs/2609.02695)
*Hao-Ning Wu*
...
### [38] [A stable rank-adaptive step-and-truncate finite volume method for Vlasov transport on domains with piecewise linear boundaries](https://arxiv.org/abs/2609.02721)
...
### [39] [Neural operators approximate strongly continuous convex monotone semigroups](https://arxiv.org/abs/2609.02727)
...
### [40] [Continuous data assimilation in steady Navier-Stokes equations with unknown viscosity: robust and efficient solvers and fast parameter recovery](https://arxiv.org/abs/2609.02862)
