...
### [1] [Van Vleck spectra of high-order Heun operators:\ finite-band universality and exterior asymptotics](https://arxiv.org/abs/2607.02700)
*Boris Shapiro*
...
### [2] [Transition-Set Morphometry for Inter-Scale Contacts in Digital Sandstones](https://arxiv.org/abs/2607.02737)
*O. M. Kiselev*
...
### [3] [A new PBW basis for the alternating central extension of the $q$-Onsager algebra](https://arxiv.org/abs/2607.02849)
*Haoran Zhu*
...
### [4] [The Oracle Theorem for Matrix-Valued Jacobi Operators](https://arxiv.org/abs/2607.03507)
...
### [5] [Anomalous rate of eigenstate thermalisation at singularities of the density of states](https://arxiv.org/abs/2607.03546)
...
### [6] [The Dirichlet Laplacian with a point interaction on unbounded Lipschitz domains](https://arxiv.org/abs/2607.04349)
...
### [7] [Hyperbolic Completion of Newton's Off-Center Orbit Problem: $SO(2,1)$ Symmetry, Inversion Duality, and Magnetic Classification](https://arxiv.org/abs/2607.04521)
*Dipesh Bhandari*
...
### [8] [Long-range interactions and Anderson localisation for one-dimensional high-contrast resonator chain](https://arxiv.org/abs/2607.04971)
...
### [9] [Collision geometry of relativistic spinning particles](https://arxiv.org/abs/2607.05254)
*Simone Calogero*
...
### [10] [Lower bound on the energy-momentum relation of the polaron](https://arxiv.org/abs/2607.05286)
*Steffen Polzer*
...
### [11] [Anisotropic magnetoresistance of 2D Rashba films with in-plane Zeeman field and short-range disorder](https://arxiv.org/abs/2607.02747)
...
### [12] [Electrically tunable interfacial thermal conduction via electronic structure engineering in ${Au}$/$Bi_{1-x}$$Sb_{x}$ topological insulators](https://arxiv.org/abs/2607.02899)
...
### [13] [Hall Shift Current and Nonlinear Anomalous Hall Effect in Gapped Dirac Fermion Systems](https://arxiv.org/abs/2607.02953)
*Toshihito Osada*
...
### [14] [Effects of Impurity Scattering on Orbital Hall Conductivity and Orbital Transport in Ru-based Alloys](https://arxiv.org/abs/2607.03076)
...
### [15] [Substrate-Mediated Persistent Photodoping in WSe2/hBN Field-Effect Transistors Enabled by Defect States in SiO2](https://arxiv.org/abs/2607.03121)
...
### [16] [Comparative Evaluation of Encapsulation Methods for Endohedral Doping of Single-Wall Carbon Nanotubes](https://arxiv.org/abs/2607.03151)
...
### [17] [One-dimensional carbon nanostructures with periodic graphitic nitrogen substitution](https://arxiv.org/abs/2607.03267)
...
### [18] [Many-body quantum chaos in excitonic spectra from first principles](https://arxiv.org/abs/2607.03294)
...
### [19] [Emergent $\mathbb{Z}$-type topology in a quasi-one-dimensional extended QWZ model](https://arxiv.org/abs/2607.03401)
...
### [20] [Evidence of length scale effect in contact electrification in conducting thin film heterostructures](https://arxiv.org/abs/2607.03428)
...
### [21] [Graphene Electric Double-Layer Transistors for Enhanced-Sensitivity Label-Free Detection of Human Serum Albumin](https://arxiv.org/abs/2607.03491)
...
### [22] [Robustness of quantized Hall resistivity under cavity coupling at zero temperature](https://arxiv.org/abs/2607.03511)
...
### [23] [Nonlocal Orbital-Angular-Momentum Dichroism of Vortex Light in Strained Crystals](https://arxiv.org/abs/2607.03544)
*Habib Rostami*
...
### [24] [Hybrid-order nonlinear topological phases](https://arxiv.org/abs/2607.03678)
...
### [25] [Graph-Based Kirchhoff Modeling of Non-Ohmic Electron Transport in Self-Assembled Nanonecklace Networks](https://arxiv.org/abs/2607.03698)
...
### [26] [Spin-orbit torque-driven synthetic antiferromagnetic oscillator](https://arxiv.org/abs/2607.03708)
...
### [27] [Nonlinear Hall effect in Floquet-driven monolayer 1T$'$-MoS$_2$](https://arxiv.org/abs/2607.03717)
...
### [28] [Spin-momentum locking of polariton edge states in honeycomb lattices](https://arxiv.org/abs/2607.03961)
...
### [29] [Phase-Factor-Controlled Interaction and Bonding between a Chiral Bobber and a Skyrmion String in the Conical Phase](https://arxiv.org/abs/2607.04266)
...
### [30] [Quasi-two-dimensional Majorana zero modes from finite-size-coupled chiral hinge states](https://arxiv.org/abs/2607.04358)
...
### [31] [Quantum Geometric Friedel Oscillations](https://arxiv.org/abs/2607.04654)
...
### [32] [Tunable Nonlinear Landscapes in Graphene Nanoelectromechanical Systems](https://arxiv.org/abs/2607.04724)
...
### [33] [Observation of Non-linear hall effect in Polycrystalline magnetic multilayes](https://arxiv.org/abs/2607.04754)
...
### [34] [On the $\mathrm{In_{x}Ga_{1-x}As}$ channel noise in InP HEMTs from 4 K to 300 K](https://arxiv.org/abs/2607.04757)
...
### [35] [Strain- and potential-controlled tunneling in monolayer MoS$_2$](https://arxiv.org/abs/2607.04766)
...
### [36] [Local Defects and the Topology of the Haldane Model](https://arxiv.org/abs/2607.04771)
...
### [37] [A Unified Electrostatic-to-Spin Framework for Asymmetric Multi-Gate CMOS Quantum Devices](https://arxiv.org/abs/2607.04876)
...
### [38] [Lindblad theory of linear response susceptibility and dispersive readout in minimal Kitaev junctions](https://arxiv.org/abs/2607.04968)
...
### [39] [Functionalization of $g$-wave altermagnets: spin-splitter effect enabled by surfaces](https://arxiv.org/abs/2607.04970)
*Sopheak Sorn*
...
### [40] [Coexisting Charge Density Wave and Superconducting Order in Quantizing Magnetic Fields](https://arxiv.org/abs/2607.05039)
...
### [41] [Finite-frequency magnetic common baths in ferromagnetic planar cavities](https://arxiv.org/abs/2607.05066)
*O. J. Kwon*
...
### [42] [Platinum is a Photocatalyst: Large Visible-Light Quantum Efficiency Revealed](https://arxiv.org/abs/2607.05172)
...
### [43] [Spectral-topology-induced criticality in non-Hermitian fermionic metals](https://arxiv.org/abs/2607.05190)
...
### [44] [Dielectric function in WSe2](https://arxiv.org/abs/2607.05371)
...
### [45] [Mitigating Numerical Stiffness in Least-Squares Formulations of Elliptic PDEs for Physics-Informed Neural Networks](https://arxiv.org/abs/2607.02726)
...
### [46] [Nonlinear Parareal-Incomplete OSWR Method for the Coupled Reaction-Diffusion System: Convergence Analysis and Computational Strategies](https://arxiv.org/abs/2607.02780)
...
### [47] [Kernel-based learning of manifold-to-manifold maps from scattered data](https://arxiv.org/abs/2607.02789)
...
### [48] [A Geometric Local Parameterization Method for Generalized Hele-Shaw Free Boundary Problems with Source Terms](https://arxiv.org/abs/2607.02880)
...
### [49] [Direct Sampling Methods for Inverse Interface Problems](https://arxiv.org/abs/2607.02913)
...
### [50] [Subspace curvature-scaling high-index saddle dynamics for accelerating ill-conditioned saddle point searches](https://arxiv.org/abs/2607.03030)
...
### [51] [Directionally Weighted Total Variation for Inverse Problems](https://arxiv.org/abs/2607.03054)
...
### [52] [Finite element approximation of the enthalpy formulation for Stefan problems on evolving surfaces](https://arxiv.org/abs/2607.03219)
...
### [53] [An Onsager Variational Scheme for Pressure-Driven Tumor Growth and Hele-Shaw Limits](https://arxiv.org/abs/2607.03252)
...
### [54] [Accelerating droplet-laden Stokes flow simulations with hierarchical surrogate modeling](https://arxiv.org/abs/2607.03301)
...
### [55] [Convergence of Substructuring Waveform Relaxation Algorithms for Hyperbolic PDEs with Time Delay](https://arxiv.org/abs/2607.03326)
...
### [56] [Pointwise Error Estimates for Numerical Physics-Informed Neural Networks](https://arxiv.org/abs/2607.03431)
...
### [57] [An LSQR-based algorithm for large-scale null space computations](https://arxiv.org/abs/2607.03341)
*Jinzhi Huang*
...
### [58] [Amortized low-rank approximation for hyperparameter marginalization in PDE-governed Bayesian inverse problems](https://arxiv.org/abs/2607.03355)
...
### [59] [Sketch low-rank dynamics: orthogonal vs. oblique projections](https://arxiv.org/abs/2607.03402)
...
### [60] [Coalesced Matrix-Free Geometric Multigrid on Persistent Cell-Wise Storage](https://arxiv.org/abs/2607.03413)
*Michał Wichrowski*
...
### [61] [A perfectly matched layer approach for the spectral split-step Padé method](https://arxiv.org/abs/2607.03521)
...
### [62] [Edge Multiscale Finite Element Methods](https://arxiv.org/abs/2607.03710)
...
### [63] [Direct sampling methods for inverse medium scattering problems of elastic waves](https://arxiv.org/abs/2607.03745)
...
### [64] [Level-set physics-informed neural networks for domain inverse problems of gravimetry](https://arxiv.org/abs/2607.03772)
...
### [65] [Discretisation of Eulerian nonlinear elasticity and diffusion using gradient flows](https://arxiv.org/abs/2607.03829)
...
### [66] [Virtual element methods for a class of fully nonlinear elliptic PDEs](https://arxiv.org/abs/2607.03850)
...
### [67] [Accelerated iterative method for solving the steady-state Boltzmann equation](https://arxiv.org/abs/2607.03910)
...
### [68] [Second-Moment Method for Transport Problems with Anisotropic Scattering](https://arxiv.org/abs/2607.03967)
...
### [69] [A revisit to DeTurck method on curve shortening flow with optimal error analysis](https://arxiv.org/abs/2607.04105)
*Beiping Duan*
...
### [70] [Guaranteed Lower Eigenvalue Bounds for Spectral Galerkin Methods with Application to Schrödinger Operators](https://arxiv.org/abs/2607.04247)
*Xuefeng Liu*
...
### [71] [Domain decomposition methods with Physics-informed neural networks for elliptic equations on manifolds](https://arxiv.org/abs/2607.04285)
...
### [72] [Mesh-Uniform Stability and Error Estimates for HDG Discretizations of the Helmholtz Equation](https://arxiv.org/abs/2607.04507)
*Yukun Yue*
...
### [73] [Smoothing by, and eccentric smoothing of, compactly supported RBFs](https://arxiv.org/abs/2607.04512)
...
### [74] [Determinant Characteristics and Argument-Principle Certification for Visible Poles in Meromorphic Continuation](https://arxiv.org/abs/2607.04568)
...
### [75] [Hydro-mechanical Model for Slope Stability Assessment: A polygonal stabilization-free discretization](https://arxiv.org/abs/2607.04778)
...
### [76] [Pressure-robust $hp$-a posteriori error estimates of $\boldsymbol{H}(\mathrm{div})$-conforming discontinuous Galerkin methods for the Stokes equations](https://arxiv.org/abs/2607.04787)
...
### [77] [Arbitrary high order splitting methods for linear Schr{ö}dinger equations with non-trivial compatibility conditions](https://arxiv.org/abs/2607.04835)
...
### [78] [An Equivalence result for sketched Anderson Acceleration and sketched GMRES](https://arxiv.org/abs/2607.04904)
...
### [79] [Quadrature rules for the mass and stiffness matrices of finite elements for the wave equation on the 2-, 3- and 4-simplex](https://arxiv.org/abs/2607.04995)
*W. A. Mulder*
...
### [80] [Convergence analysis of a MAC scheme for the barotropic Euler system](https://arxiv.org/abs/2607.05105)
