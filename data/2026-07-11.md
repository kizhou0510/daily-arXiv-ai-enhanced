...
### [1] [Off-site enforcement of natural conditions on smooth boundaries for finite elements upon fitted straight-edged triangular meshes](https://arxiv.org/abs/2607.07963)
*Vitoriano Ruas*
...
### [2] [A Non-Decoupled Time-Domain Direct Sampling Method for Inverse Elastic Medium Scattering](https://arxiv.org/abs/2607.08067)
...
### [3] [Multi-type Sensor Placement for PDE-based Bayesian Inverse Problems](https://arxiv.org/abs/2607.08074)
...
### [4] [3D Virtual Element Method for Advection-Diffusion-Reaction Problems with Variable Coefficients on Locally Quasi-Uniform Polytopes](https://arxiv.org/abs/2607.08237)
*M. Trezzi*
...
### [5] [Splitting methods for nonlinear Schrödinger equation without order reduction](https://arxiv.org/abs/2607.08387)
...
### [6] [High-order complete flux schemes for convection-diffusion equations on arbitrary subdivisions](https://arxiv.org/abs/2607.08422)
...
### [7] [Universality and Dynamical Inequivalence in Isospectral Non-Hermitian Anderson Transitions](https://arxiv.org/abs/2607.07714)
...
### [8] [Axion-Induced Casimir Interaction Between Graphene Plates](https://arxiv.org/abs/2607.07757)
...
### [9] [Gate induced strain on a two-dimensional hole gas in silicon](https://arxiv.org/abs/2607.07932)
...
### [10] [Magnetic control of Goos-Hänchen shifts and group delay time in monolayer WSe$_2$](https://arxiv.org/abs/2607.08315)
...
### [11] [Kime-Representation Formulations of Three Open Problems in the Foundations of Classical Mechanics: Uncertainty, Invariant Entropy, and Directional Degrees of Freedom](https://arxiv.org/abs/2607.07851)
*Ivo D. Dinov*
...
### [12] [An edge-bicolored graph approach to the Ising model on random regular graphs](https://arxiv.org/abs/2607.07867)
...
### [13] [The Periodic Table and the Group SO(4,4): II. Double SO(4,2)-tower](https://arxiv.org/abs/2607.08105)
*V. V. Varlamov*
...
### [14] [Wigner symmetries single out symmetric Wasserstein distances in all finite dimensions](https://arxiv.org/abs/2607.08298)
*Gergely Bunth*
...
### [15] [The Fock Space Dynamics of Causal Fermion Systems: Non-Abelian Gauge Fields](https://arxiv.org/abs/2607.08488)
...
### [16] [Multifractality of Semiclassical Measures on Star Graphs](https://arxiv.org/abs/2607.08496)
*Marius Nietschmann*
...
### [17] [Renormalization flows for 1D mixed states and a quantum Goursat lemma](https://arxiv.org/abs/2607.08568)
