...
### [1] [A Symmetry-Preserving Tensor $\star_{\mathbf{M}}$-SVD](https://arxiv.org/abs/2608.24985)
...
### [2] [Entropy-stable moving-wall boundary conditions for the ALE formulation of the compressible Navier-Stokes equations](https://arxiv.org/abs/2608.25146)
...
### [3] [ROMNet: a hybrid reduced order modeling and machine learning approach to waveform inversion](https://arxiv.org/abs/2608.25160)
...
### [4] ["Truncated Fourier Filtering" method for fast and high-order evaluation of integrals and convolutions in general domains](https://arxiv.org/abs/2608.25264)
...
### [5] [CARE-SAV: A Conditioning-Aware Random-Feature Framework for Energy-Stable Simulation of Gradient Flows](https://arxiv.org/abs/2608.25300)
...
### [6] [Data-driven Effective Modeling of Stochastic Chemical Reaction Networks](https://arxiv.org/abs/2608.25421)
...
### [7] [Adaptive Hybrid Subspace Levenberg Marquardt Algorithm with Adequacy Monitor for Large Scale Least Squares Problems](https://arxiv.org/abs/2608.25524)
...
### [8] [Preconditioning for Diffuse Interface Tumor Growth Models](https://arxiv.org/abs/2608.25537)
...
### [9] [Combined High-Dimensional and Reduced-Order Modeling Based on an Iterative Domain Decomposition Method](https://arxiv.org/abs/2608.25567)
...
### [10] [A family of second order, linear, unconditionally stable methods for the Cahn-Hilliard-Navier-Stokes equations](https://arxiv.org/abs/2608.26046)
...
### [11] [A Computational Model for Global Ocean Dynamics at all Scales](https://arxiv.org/abs/2608.25679)
*Peter Korn*
...
### [12] [Explicit domain preserving numerical schemes for a class of stochastic differential equations](https://arxiv.org/abs/2608.25685)
...
### [13] [Analysis of a first-order explicit positivity preserving scheme for a class of scalar SDEs](https://arxiv.org/abs/2608.25689)
*Charles-Edouard Bréhier,David Cohen*
...
### [14] [Exactly Diagonal Gram Matrices in Jacobi Weighted Histopolation](https://arxiv.org/abs/2608.25714)
...
### [15] [Error Analysis of the Inverse Conductivity Problem with Scattered Measurements](https://arxiv.org/abs/2608.25749)
...
### [16] [Updating and Downdating the Recurrences of Discrete Multiple Orthogonal Polynomials on the Real Line](https://arxiv.org/abs/2608.25758)
...
### [17] [From estimate to proof: certified ground-state energy bounds for singular Schrödinger operators](https://arxiv.org/abs/2608.25760)
*Xuefeng Liu*
...
### [18] [Block preconditioning for all-at-once variable-coefficient fractional evolution equations via the GLT analysis](https://arxiv.org/abs/2608.25796)
...
### [19] [Adaptive Nesterov Momentum Method for Electrical Impedance Tomography with the Complete Electrode Model](https://arxiv.org/abs/2608.25837)
...
### [20] [A Neural-network-based multiscale Hybridizable Discontinuous Galerkin method for solving PDEs in porous media](https://arxiv.org/abs/2608.25850)
*Tony Haines,Ke Shi*
...
### [21] [Required Number of Points in $L_2$ Marcinkiewicz-Zygmund Inequalities](https://arxiv.org/abs/2608.25886)
*Felix Bartel*
...
### [22] [Optimized Multilevel Sampling Methods under Resource Constraints](https://arxiv.org/abs/2608.25958)
*Niklas Baumgarten*
...
### [23] [Risk-averse Optimization in Random Materials: Algorithmic Advances and HPC Acceleration](https://arxiv.org/abs/2608.25967)
...
### [24] [The Pauli Lightcone: Information-Theoretic Error Mitigation Beyond the Autocorrelation](https://arxiv.org/abs/2608.25254)
*Paolo D'Alberto*
...
### [25] [Exact topology of conservative multiplicative cascades: An ultrametric transfer-operator genus](https://arxiv.org/abs/2608.24897)
*Cristiano G. Sabiu*
...
### [26] [Free-Energy Asymptotics of the Two-Dimensional Quantum Heisenberg Ferromagnet](https://arxiv.org/abs/2608.25506)
*Andreas Klippel*
...
### [27] [Threshold spectral transition for a fermion-boson pair on the one-dimensional lattice](https://arxiv.org/abs/2608.25582)
...
### [28] [Lower bounds on the spatial decay of the ground state of the Pauli-Fierz model](https://arxiv.org/abs/2608.25719)
...
### [29] [Plasticity as Directional Stationarity: Yielding, Flow, and Hardening from One Functional](https://arxiv.org/abs/2608.25991)
*Huilong Ren*
...
### [30] [A Simple Regularization of the Smooth Quantum Hydrodynamic Model](https://arxiv.org/abs/2608.24950)
*Carl L. Gardner*
...
### [31] [Photonic spin-Hall effect as a probe for time-reversal-symmetry broken band topological phases](https://arxiv.org/abs/2608.25002)
...
### [32] [Carrier-Resolved Attosecond Valley Polarimetry of Monolayer MoS$_2$](https://arxiv.org/abs/2608.25121)
...
### [33] [Signatures of a ferro-Josephson effect in twisted graphene](https://arxiv.org/abs/2608.25257)
...
### [34] [Metastable magnetic domains and the anomalous $B_\parallel=0$ resistance peak in twisted double bilayer graphene](https://arxiv.org/abs/2608.25263)
...
### [35] [Quantum geometric signatures of Link-Unlink transitions and nonlinear Hall response in Hopf-link semimetals](https://arxiv.org/abs/2608.25352)
...
### [36] [Non-Hermitian topological Euler insulators](https://arxiv.org/abs/2608.25411)
*Longwen Zhou*
...
### [37] [Chirality-Selective Phonon Pumping by Ferroelectric Dynamics](https://arxiv.org/abs/2608.25684)
...
### [38] [Light-Hole Spin Qubits in Strained SiGe Lattice-Matched to Ge](https://arxiv.org/abs/2608.25852)
...
### [39] [Topological phases of a generalised tripartite Haldane model](https://arxiv.org/abs/2608.25875)
...
### [40] [Switchable heavy-hole/light-hole spin qubit](https://arxiv.org/abs/2608.25914)
...
### [41] [Size and Impurity Effects on Scattering of Valley Hall Modes in Gate-Defined Bilayer Graphene Superlattices](https://arxiv.org/abs/2608.25931)
...
### [42] [Depth Control of Room-Temperature Quantum Emitters in Gallium Nitride](https://arxiv.org/abs/2608.26057)
...
### [43] [Viscochiral Transport: Chiral Selection of Hydrodynamic Vortices by Berry Curvature](https://arxiv.org/abs/2608.26102)
...
### [44] [Multicomponent Magnetic Domain Walls in Rhombohedral Graphene](https://arxiv.org/abs/2608.26104)
