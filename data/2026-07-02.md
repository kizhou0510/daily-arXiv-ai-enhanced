...
### [1] [An analog ac voltage amplifier based on a single straintronic magnetic tunnel junction](https://arxiv.org/abs/2607.00104)
...
### [2] [Universal Scaling of the Spin Hall Effect](https://arxiv.org/abs/2607.00343)
...
### [3] [Modulation of anomalous Hall angle in a magnetic topological semimetal](https://arxiv.org/abs/2607.00396)
...
### [4] [Real-time dynamics of triplet-resonant tunneling driven by nonequilibrium phonons](https://arxiv.org/abs/2607.00520)
...
### [5] [Robustness of Quantum Discord in Nonequilibrium Electronic Transport through Tunnel-Coupled Quantum Dots](https://arxiv.org/abs/2607.00602)
...
### [6] [Spinterface-like mechanism of the chirality-induced spin selectivity in donor chiral-bridge acceptor complexes](https://arxiv.org/abs/2607.00668)
...
### [7] [Facet-selective ballistic supercurrent in a weak topological insulator](https://arxiv.org/abs/2607.00683)
...
### [8] [Universal logic circuit for gate-controlled superconductor-based switches operating at liquid-helium temperatures](https://arxiv.org/abs/2607.00769)
...
### [9] [Electrical control of spin photocurrent in a magnetoelectric oxide Cr$_2$O$_3$](https://arxiv.org/abs/2607.00807)
...
### [10] [Symmetry Classification of Non-Reciprocal Responses in Multiterminal Ring Devices](https://arxiv.org/abs/2607.00919)
...
### [11] [Modification of Damon-Eshbach magnetostatic mode spectra in ferromagnet/paramagnet bilayer](https://arxiv.org/abs/2607.00964)
*M. A. Kuznetsov*
...
### [12] [Magnon-polaron mediated spin Seebeck effect in altermagnets](https://arxiv.org/abs/2607.00993)
...
### [13] [Exceptional points in dissipative coupling polaron-polaritons](https://arxiv.org/abs/2607.00994)
...
### [14] [Bandwidth-Limited Critical Currents in Electrically Tunable Moiré Bands](https://arxiv.org/abs/2607.01056)
...
### [15] [Confinement in a magnetically induced WSe$_2$ quantum dots](https://arxiv.org/abs/2607.01192)
...
### [16] [On the Application of Poincare-Steklov Operators to the Problem of Resonant Scattering in a Cylinder](https://arxiv.org/abs/2607.00656)
*A. L Delitsyn*
...
### [17] [Time Averages for the Vortex Model and Stroboscopic Ergodic Averages](https://arxiv.org/abs/2607.00721)
...
### [18] [On the spherical symmetry and finite-range assumptions of the interaction potential in the low energy study of dilute Bose gases](https://arxiv.org/abs/2607.00859)
...
### [19] [Scattering, Trapping and Cloaking-Type Effects of Plane Waves by Point Scatterers in Strain Gradient Elasticity](https://arxiv.org/abs/2607.01070)
...
### [20] [A scheme for topological phases of the Weyl $C^*$-algebra](https://arxiv.org/abs/2607.01183)
...
### [21] [Fractal-Fractional HIV Dynamics with Mittag-Leffler Kernel: Analysis, Stability, and Numerical Simulations](https://arxiv.org/abs/2607.00061)
...
### [22] [Identifying defective units in infinite periodic arrays of point sources](https://arxiv.org/abs/2607.00241)
...
### [23] [Quantum Simulation of Stokes Flow via Schrödingerisation and Artificial Compressibility](https://arxiv.org/abs/2607.00281)
...
### [24] [Rigorous analysis of the time-splitting methods for the semiclassical Dirac equation](https://arxiv.org/abs/2607.00335)
*He Wang,Jia Yin*
...
### [25] [Relaxed Lagrange Multiplier (RLM) Schemes for Phase Field Models Preserving the Relaxed Original Energy Dissipation Law](https://arxiv.org/abs/2607.00355)
...
### [26] [WarpagePINN: Thermal Warpage Prediction in Advanced Packaging via a Two-Stage Physics-Informed Neural Networks](https://arxiv.org/abs/2607.00364)
...
### [27] [Physics Informed Neural Networks for Nonlinear Delay Differential Equations](https://arxiv.org/abs/2607.00380)
...
### [28] [Exponential Low-Regularity Parareal Algorithms for Nonlinear Schrödinger Equations](https://arxiv.org/abs/2607.00384)
*Qingle Lin,Zhi Zhou*
...
### [29] [Data-Adaptive Learning of Dynamical Systems by Matching Transfer Operators and Invariant Measures](https://arxiv.org/abs/2607.00391)
...
### [30] [An Inner-Outer Iteration Algorithm with Optimal Parameters for Stochastic Lyapunov Matrix Equation](https://arxiv.org/abs/2607.00451)
...
### [31] [A Nonstandard Finite Difference Scheme for a Nonlinear Parabolic Equation with p-Laplacian-Type Diffusion](https://arxiv.org/abs/2607.00489)
...
### [32] [A multilevel stochastic-gradient neural solver for boundary integral equations](https://arxiv.org/abs/2607.00560)
...
### [33] [Hermite Semi-Lagrangian schemes on triangular meshes for advection equations](https://arxiv.org/abs/2607.00619)
...
### [34] [Convolutional Symmetric AutoEncoders: enhancing latent stability via differential geometry](https://arxiv.org/abs/2607.00669)
...
### [35] [Penalty-Free Natural Deep Ritz Method Based on de Rham Complex for High-Dimensional Dirichlet Boundary Value Problems](https://arxiv.org/abs/2607.00676)
...
### [36] [Goal-oriented space-time adaptivity for the Navier--Stokes equations based on the dual weighted residual method](https://arxiv.org/abs/2607.00686)
...
### [37] [A linear, decoupled and positivity-preserving time-staggered block-centered finite difference method for the multi-species Keller-Segel chemotaxis system](https://arxiv.org/abs/2607.00713)
...
### [38] [Proxy-surface-based fast direct solver for TE-mode scattering problems on distributed memory systems](https://arxiv.org/abs/2607.00790)
...
### [39] [Hybridizable Staggered Discontinuous Galerkin Methods for Polyharmonic Equations on Polytopes](https://arxiv.org/abs/2607.00831)
...
### [40] [Overlapping Domain Decomposition for Meshless Finite Difference Methods](https://arxiv.org/abs/2607.00842)
...
### [41] [Certification of PGD reduced-order models with separated spatial variables](https://arxiv.org/abs/2607.00896)
...
### [42] [A Superfast Direct Solver for 2D Type-II Inverse Nonuniform Discrete Fourier Transform Based on Hierarchically Semiseparable Matrix](https://arxiv.org/abs/2607.00928)
...
### [43] [Compression of Polyconvex Envelopes of Isotropic Functions via Monotonic Input Convex Neural Networks](https://arxiv.org/abs/2607.01055)
