...
### [13] [An FBSDE Construction of the Sine-Gordon EQFT for $β^{2} < \frac{6}{7}\, 8π$ and Perturbative Renormalization in the Full Subcritical Regime](https://arxiv.org/abs/2607.20632)
*Sarah-Jean Meyer*
...
### [14] [Affine Extension of the Free-Particle--Oscillator--Inverted-Oscillator Triangle](https://arxiv.org/abs/2607.20711)
...
### [15] [High-resolution decomposition of canonical Hamiltonian systems](https://arxiv.org/abs/2607.20740)
...
### [16] [An Operator-Algebraic Exposition of the Thirring-Wehrl Theory of the Quasi-Spin BCS Model](https://arxiv.org/abs/2607.21158)
*Yoshitsugu Sekine*
...
### [17] [Continuum limit of discretized matrix-valued Fourier multipliers](https://arxiv.org/abs/2607.21177)
...
### [18] [Representation of the causal logic for the Dirac system and the electron](https://arxiv.org/abs/2607.21266)
...
### [19] [On Leray's Theoreme de Structure for a weak solution to the Navier-Stokes equations: an improvement of the result](https://arxiv.org/abs/2607.21380)
*Paolo Maremonti*
...
### [20] [Two-phase source and reaction coefficient Stefan type problems](https://arxiv.org/abs/2607.21388)
*Targyn A. Nauryz*
...
### [21] [Convergence and mixed-precision preconditioning for the naive Jacobi eigenvalue algorithm](https://arxiv.org/abs/2607.20749)
...
### [22] [A virtual element method for Darcy's problem coupled with a heat equation](https://arxiv.org/abs/2607.20755)
...
### [23] [Hierarchical Log-Gaussian Relaxation on a Fixed D3Q125 Velocity Set](https://arxiv.org/abs/2607.20846)
*Bjørn Wu*
...
### [24] [High-Order Exponential Integrators with Improved Uniform Accuracy for Charged-Particle in a Perpendicular Strong Magnetic Field](https://arxiv.org/abs/2607.21096)
...
### [25] [A stability-preserving polytopal discontinuous Galerkin method for the Fisher-Kolmogorov model with applications to neurodegenerative diseases](https://arxiv.org/abs/2607.21108)
...
### [26] [A Damped SWIFT Method for European Option Pricing: Coefficients Decay, Truncation, and Error Analysis](https://arxiv.org/abs/2607.21109)
...
### [27] [A Mixed Discrete Cosserat Rod Formulation](https://arxiv.org/abs/2607.21164)
...
### [28] [A Hyper-Reduced Neural Network-Augmented Semi-smooth Newton Method for Nonlinear Parametric Variational Inequalities](https://arxiv.org/abs/2607.21242)
...
### [29] [Adaptive Non-Linear Partition of Unity Methods for Scattered Data Interpolation with Discontinuities](https://arxiv.org/abs/2607.21287)
...
### [30] [On the Approximation of the Unitary Operator Group Associated with a Rotation Matrix and Its Applications to Abstract Hyperbolic Equations](https://arxiv.org/abs/2607.21293)
...
### [31] [An unfitted boundary algebraic equation method with Calderón preconditioning for 2D Stokes flow in irregular geometry](https://arxiv.org/abs/2607.21295)
...
### [32] [3D Uncertainty Quantification for the Photo-Acoustic Tomography](https://arxiv.org/abs/2607.21373)
...
### [33] [Jordan algebras, hemiplex numbers, and the Cholesky decomposition of arbitrary symmetric matrices](https://arxiv.org/abs/2607.21383)
...
### [34] [librla: Randomized Linear Algebra Library](https://arxiv.org/abs/2607.20732)
