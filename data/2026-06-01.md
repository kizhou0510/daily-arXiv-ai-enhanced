...
### [1] [A Boundary--Residue Incidence Coalgebra for Associahedral Scattering Forms](https://arxiv.org/abs/2605.30390)
*Ioannis P. Zois*
...
### [2] [BV pushforward as a quasi-isomorphism](https://arxiv.org/abs/2605.30558)
...
### [3] [A sharp three-particle fractional Hardy inequality and an angular Selberg-type identity](https://arxiv.org/abs/2605.30586)
...
### [4] [Hubbard--Heisenberg Thermodynamic Comparison at Half Filling in a Fixed Staggered Field](https://arxiv.org/abs/2605.30663)
*Tadahiro Miyao*
...
### [5] [Novel energy preserving bijections between affine crystals for $U_q(\widehat{\mathfrak{sl}}_2)$ and integer partitions](https://arxiv.org/abs/2605.30806)
...
### [6] [Geometric Analysis of the Damped Harmonic Oscillator via the Lambert W Function](https://arxiv.org/abs/2605.31456)
...
### [7] [Numerical analytical continuation of multivariate hypergeometric functions](https://arxiv.org/abs/2605.31553)
...
### [8] [Variational theory of Cosserat arches and affine tensors](https://arxiv.org/abs/2605.31570)
*Géry de Saxcé*
...
### [9] [Superconductor-"Metal" Transition of One-dimensional Interacting Bosons with Ohmic Quantum Dissipation](https://arxiv.org/abs/2605.30746)
*Miguel A. Cazalilla*
...
### [10] [Spin Hall effect in two-dimensional materials with inverted bands and Mexican-hat dispersion](https://arxiv.org/abs/2605.30881)
...
### [11] [Pure Spin Photocurrent in Altermagnetic Photovoltaic Battery](https://arxiv.org/abs/2605.30909)
...
### [12] [Parity-induced generalized Brillouin zone without non-Hermitian skin effect](https://arxiv.org/abs/2605.30978)
*Alexander Felski*
...
### [13] [Interplay of Cl Substitution and He$^{+}$ Irradiation in CrSBr$_{1-x}$Cl$_{x}$](https://arxiv.org/abs/2605.31134)
...
### [14] [The geometry of the CISS effect](https://arxiv.org/abs/2605.31166)
...
### [15] [A charge qubit on solid neon in a spin-qubit compatible circuit QED platform](https://arxiv.org/abs/2605.31185)
...
### [16] [Surface lone-pair polarization probed by quantum-geometric transport in tellurium](https://arxiv.org/abs/2605.31197)
...
### [17] [Valley-polarized Orbital and Spin Magnetism Induced by Femtosecond Optical Pulses in Two-Dimensional Semiconductors](https://arxiv.org/abs/2605.31263)
...
### [18] [Feasibility study of continuous electronic Pomeranchuk cooling with a flavor-degenerate Wigner crystal](https://arxiv.org/abs/2605.31307)
...
### [19] [Nonperturbative renormalization of Haldane pseudopotentials from the exact two-electron spectrum](https://arxiv.org/abs/2605.31537)
...
### [20] [Algebraic and FFT-Based Methods for Discrete-Time Matrix Convolutions with Applications to Semi-Markov Models](https://arxiv.org/abs/2605.30379)
...
### [21] [Entropy-stable and energy-conservative fully-discrete finite element method for non-isothermal phase-field models](https://arxiv.org/abs/2605.30559)
...
### [22] [Lightning Plus Polynomial Approximation: Optimal Root-Exponential Convergence for Singular Functions in Corner Domains](https://arxiv.org/abs/2605.30796)
...
### [23] [A Multi-Invariant Preserving Discrete Gradient Methods](https://arxiv.org/abs/2605.30827)
...
### [24] [Magnetic Resonance Dynamics via Fractional Bloch Equation: a Hybrid Computational Framework](https://arxiv.org/abs/2605.30856)
...
### [25] [Structure-Informed Bounds on the Kronecker Rank of Block-Structured Matrices](https://arxiv.org/abs/2605.30908)
...
### [26] [A novel Chebyshev collocation method for elliptic -type differential equations with degenerate coefficient](https://arxiv.org/abs/2605.31055)
...
### [27] [Solving Coupled Tensor Equation $\mathcal{A} \ltimes \mathcal{X} =\mathcal{B}, \ \mathcal{X}\ltimes \mathcal{C}=\mathcal{D}$ using Semi-Tensor Products in the t-product](https://arxiv.org/abs/2605.31122)
...
### [28] [A holomorphic neural network framework for 3D boundary value problems governed by harmonic potentials](https://arxiv.org/abs/2605.31231)
...
### [29] [Stochastic bifurcation analysis via polynomial chaos: consistency and convergence of branch-approximating solutions](https://arxiv.org/abs/2605.31288)
...
### [30] [Cohomology of Finite Element Stokes Complexes on Alfeld Splits](https://arxiv.org/abs/2605.31348)
...
### [31] [Spectral density estimation for normal matrices](https://arxiv.org/abs/2605.31430)
...
### [32] [Spectral coarse spaces based on indefinite operators: the $H_k$-GenEO method](https://arxiv.org/abs/2605.31552)
