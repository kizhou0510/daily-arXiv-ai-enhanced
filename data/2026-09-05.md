...
### [2] [Computational Algorithms for Invariant Reduction of Variational Forms](https://arxiv.org/abs/2609.03197)
...
### [3] [Optimal bounds for embedded eigenvalues of one-dimensional discrete Schrödinger operators with decaying potentials](https://arxiv.org/abs/2609.03224)
...
### [4] [Controllability, returning waves and scattering without reverberation in 3D acoustic dynamic system](https://arxiv.org/abs/2609.03536)
...
### [5] [The conductivity matrix at the topological phase transition](https://arxiv.org/abs/2609.03832)
...
### [6] [Classification of abstract Bose field models](https://arxiv.org/abs/2609.03863)
*Yasumichi Matsuzawa*
...
### [7] [Limits of Stochastic Semigroups and Block-Triangular Majorisation](https://arxiv.org/abs/2609.04057)
...
### [8] [A simple derivation of the zero-temperature BCS functional from the reduced BCS Hamiltonian](https://arxiv.org/abs/2609.04060)
...
### [9] [Graphene-enabled dynamic H-J switching of dipole-dipole coupling](https://arxiv.org/abs/2609.02933)
...
### [10] [A Unified Description of Dirac-Cone Anisotropies in Two Dimensions](https://arxiv.org/abs/2609.02946)
...
### [11] [Tuning Andreev reflection and conductance in proximitized nanowires through the spin-orbit field direction](https://arxiv.org/abs/2609.03020)
...
### [12] [Flux noise without flux tunability in superconducting qubits](https://arxiv.org/abs/2609.03059)
...
### [13] [Deterministic nanofabrication for engineering nanowire quantum dot devices](https://arxiv.org/abs/2609.03076)
...
### [14] [Topological Boundary States and the Edge Chain in Semi-Infinite Two-Dimensional Insulators](https://arxiv.org/abs/2609.03173)
...
### [15] [Built-In Electric Field Modulation of Spontaneous Magnetism and Thermospin Transport in Boron-Nitrogen Doped Zigzag Graphene Nanoribbons](https://arxiv.org/abs/2609.03476)
...
### [16] [Spectral Function Method and Janus Quantum Numbers in Quasiperiodic Systems](https://arxiv.org/abs/2609.03555)
...
### [17] [Low-Frequency Charge Noise in Bilayer Graphene Quantum Dots](https://arxiv.org/abs/2609.03650)
...
### [18] [Weak-coupling theory of half-metals and other fractional metallic phases in biased doped Bernal bilayer graphene](https://arxiv.org/abs/2609.03679)
...
### [19] [Generalized s-d model for Wannier-Mott excitons in layered magnetic semiconductors](https://arxiv.org/abs/2609.03744)
...
### [20] [Real-space Floquet topology written by the orbital angular momentum of light](https://arxiv.org/abs/2609.03752)
...
### [21] [Coherent interaction of WS$_2$ and quasi-2D perovskite excitons over micrometer distances via a cavity field](https://arxiv.org/abs/2609.03765)
...
### [22] [Unravelling the Li-Haldane Conjecture with the Projected Ensemble](https://arxiv.org/abs/2609.03833)
...
### [23] [The Casimir free energy of peptide films on a silicon substrate: Impact of dielectric-to-metal transition in silicon and nanoparticles in peptide](https://arxiv.org/abs/2609.03841)
...
### [24] [Hierarchy of topological superconductivity generated via heterostructures of unconventional $p$-wave magnets](https://arxiv.org/abs/2609.03907)
...
### [25] [Strongly anisotropic non-Kramers electron spin as a quantum coherence probe of angular fluctuations](https://arxiv.org/abs/2609.03989)
...
### [26] [Extrinsic orbital Edelstein effect from asymmetric scattering](https://arxiv.org/abs/2609.04093)
...
### [27] [Hydrodynamics of two-dimensional electrons due to scattering by disorder](https://arxiv.org/abs/2609.04097)
...
### [28] [Buckling Prediction for Nonlinear Elastic Beams with Soft Inclusions](https://arxiv.org/abs/2609.02956)
...
### [29] [Dimensional hyperreduction of nonlinear finite element models via empirical cubature with manifold-adaptive weights](https://arxiv.org/abs/2609.03068)
...
### [30] [A discontinuous Petrov-Galerkin finite-element framework for the simulation of microwave-heated flows](https://arxiv.org/abs/2609.03155)
...
### [31] [Coupled Tensor-Tensor Completion Method with Applications in Drug Repurposing](https://arxiv.org/abs/2609.03190)
...
### [32] [A novel parallel approach for solving some free boundary value problems](https://arxiv.org/abs/2609.03214)
...
### [33] [Learning Informative Prior with Infinite-Dimensional Continuous Normalizing Flow for Bayesian Inverse Problem](https://arxiv.org/abs/2609.03343)
...
### [34] [Spectral Convergence of Random Feature Method in Multiple Dimensions](https://arxiv.org/abs/2609.03401)
...
### [35] [Semi-discrete quadratic Wasserstein energy and state-dependent Langevin exploration](https://arxiv.org/abs/2609.03405)
...
### [36] [Adaptively-refinable polar-spline discrete differential forms: hierarchical construction, exactness, and applications](https://arxiv.org/abs/2609.03461)
...
### [37] [Residual neural networks overcome the curse of dimensionality for semilinear heat equations](https://arxiv.org/abs/2609.03626)
...
### [38] [A fully globalized solver for discretized inverse elliptic coefficient problems with exact data](https://arxiv.org/abs/2609.03631)
*Bastian Harrach*
...
### [39] [Mini mixed finite element method for nearly incompressible linear elasticity problems](https://arxiv.org/abs/2609.03780)
...
### [40] [A stabilized scheme satisfying the discrete maximum principle for a time fractional convection-diffusion-reaction equation](https://arxiv.org/abs/2609.03808)
...
### [41] [Closure complexity of longest-edge bisection for triangular meshes](https://arxiv.org/abs/2609.04003)
...
### [42] [Conditioning of solutions to the Sylvester equation](https://arxiv.org/abs/2609.04050)
...
### [43] [A Multigrid Method for CutFEM and its Convergence](https://arxiv.org/abs/2609.04067)
*Michal Wichrowski*
