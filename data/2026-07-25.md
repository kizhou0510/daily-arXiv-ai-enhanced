...
### [14] [Ideal Bands in Tight-Binding Models](https://arxiv.org/abs/2607.20624)
...
### [15] [High Order Geometric Channels for Nonlinear Transport in Bloch Bands](https://arxiv.org/abs/2607.20702)
...
### [16] [Exceptional Points in a Parallel Double-Quantum-Dot Josephson Junction Coupled to a Ferromagnetic Reservoir](https://arxiv.org/abs/2607.20856)
...
### [17] [Machine Learning for Charge State Characterization of Isolated Double Quantum Dots](https://arxiv.org/abs/2607.20871)
...
### [18] [End-State-Controlled Quantum Transport in Armchair Graphene Nanoribbon Artificial Quantum Materials](https://arxiv.org/abs/2607.21141)
*David M T Kuo*
...
### [19] [Exceptional-Point Geometry of Weak Topological Boundary States](https://arxiv.org/abs/2607.21148)
...
### [20] [Emergent ferromagnetism in the NiI$_2$-NbSe$_2$ van der Waals heterostructure](https://arxiv.org/abs/2607.21218)
...
### [21] [Circular phonon dichroism in $d$-wave altermagnets](https://arxiv.org/abs/2607.21221)
...
### [22] [Direct Measurement of Exciton Dispersion in the Long-Wavelength Limit](https://arxiv.org/abs/2607.21234)
...
### [23] [Visualization of Defect Electronic States in Layered Semiconductor CrSBr](https://arxiv.org/abs/2607.21301)
...
### [24] [An on-chip programmable mechano-quantum transducer](https://arxiv.org/abs/2607.21487)
...
### [25] [Probing the nonlocality of Landau levels in GaAs quantum wells through modified Purcell factors, Lamb shifts and dipole emitted spectra](https://arxiv.org/abs/2607.21528)
...
### [26] [librla: Randomized Linear Algebra Library](https://arxiv.org/abs/2607.20732)
...
### [27] [An FBSDE Construction of the Sine-Gordon EQFT for $β^{2} < \frac{6}{7}\, 8π$ and Perturbative Renormalization in the Full Subcritical Regime](https://arxiv.org/abs/2607.20632)
*Sarah-Jean Meyer*
...
### [28] [Affine Extension of the Free-Particle--Oscillator--Inverted-Oscillator Triangle](https://arxiv.org/abs/2607.20711)
...
### [29] [High-resolution decomposition of canonical Hamiltonian systems](https://arxiv.org/abs/2607.20740)
...
### [30] [An Operator-Algebraic Exposition of the Thirring-Wehrl Theory of the Quasi-Spin BCS Model](https://arxiv.org/abs/2607.21158)
*Yoshitsugu Sekine*
...
### [31] [Continuum limit of discretized matrix-valued Fourier multipliers](https://arxiv.org/abs/2607.21177)
...
### [32] [Representation of the causal logic for the Dirac system and the electron](https://arxiv.org/abs/2607.21266)
...
### [33] [On Leray's Theoreme de Structure for a weak solution to the Navier-Stokes equations: an improvement of the result](https://arxiv.org/abs/2607.21380)
*Paolo Maremonti*
...
### [34] [Two-phase source and reaction coefficient Stefan type problems](https://arxiv.org/abs/2607.21388)
*Targyn A. Nauryz*
