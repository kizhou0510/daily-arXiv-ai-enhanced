...
### [21] [Finite-Dimensional Type I von Neumann Algebras in PyTorch: A GPU-Accelerated Framework for Random Block-Diagonal Operators](https://arxiv.org/abs/2606.15882)
...
### [22] [Low Precision Fortran -- Enabling Low Precision Floating Point Arithmetic in Modern Fortran](https://arxiv.org/abs/2606.16709)
...
### [23] [Efficient Multi-Precision Computation of Bessel Functions for Real Orders and Complex Arguments with Fortran Implementation -- Part II: The Modified Bessel Function of the Second Kind, $K_ν(z)$](https://arxiv.org/abs/2606.14839)
...
### [24] [Efficient Multi-Precision Computation of Bessel Functions for Real Orders and Complex Arguments with a Fortran Implementation -- Part III: Regular Bessel Functions of the First and Second Kinds $J_ν(z)$ and $Y_ν(z)$](https://arxiv.org/abs/2606.14937)
*Mofreh R Zaghloul,Steven G. Johnson*
...
### [25] [A HDG method with transmission variables for time-harmonic wave propagation problems with constant coefficients](https://arxiv.org/abs/2606.14950)
...
### [26] [A Finite Element Approximation of an Optimal Insulation Problem with Convective Heat Transfer](https://arxiv.org/abs/2606.14991)
...
### [27] [An Energy-Conserving Unstaggered Electromagnetic-Potential Particle-in-Cell Method, Part I: Non-relativistic Generalized-Momentum Formulation](https://arxiv.org/abs/2606.15035)
...
### [28] [A Hankel determinant zero-order principle for source counting in an inverse heat point-source problem](https://arxiv.org/abs/2606.15065)
...
### [29] [A Structure-preserving Adaptive-Rank Approach to the High-Dimensional Wigner-Poisson System](https://arxiv.org/abs/2606.15067)
...
### [30] [Hybrid-high order method in space and implicit schemes in time for the biharmonic wave equation](https://arxiv.org/abs/2606.15163)
...
### [31] [A uniform-in-time weakly convergent explicit numerical method for the underdamped Langevin equation with polynomial potentials](https://arxiv.org/abs/2606.15175)
*Diancong Jin*
...
### [32] [A Staggered Discontinuous Galerkin Method for linear elasticity problem on Polytopal Meshes](https://arxiv.org/abs/2606.15223)
...
### [33] [An isotropic recovery-based error estimator algorithm for mesh adaptation in a finite volume environment with application to atmospheric flows](https://arxiv.org/abs/2606.15296)
...
### [34] [Conforming and non-conforming virtual element methods for the biharmonic Steklov eigenvalue problem with minimum regularity](https://arxiv.org/abs/2606.15340)
...
### [35] [Linear algebra at exponential scale via tensor network dimension reduction](https://arxiv.org/abs/2606.15350)
...
### [36] [Strong Stability Preserving Integrating Factor Runge-Kutta Methods for Differential Lyapunov Equations with Positivity Preservation](https://arxiv.org/abs/2606.15703)
...
### [37] [Optimized high-order IMEX-RK schemes for degenerate diffusion-reaction problems with application to travelling waves phenomena](https://arxiv.org/abs/2606.15726)
...
### [38] [Convergence of the PML-BIE Method for Acoustic Scattering in an Impedance Half-Space](https://arxiv.org/abs/2606.15878)
*Wangtao Lu*
...
### [39] [First-Order Compatible-Strain Mixed Quadrilateral Finite Elements for 2D Nonlinear Elasticity](https://arxiv.org/abs/2606.15925)
...
### [40] [Random-Feature Kalman Filtering for Linear PDE Data Assimilation](https://arxiv.org/abs/2606.16086)
...
### [41] [A priori error analysis of a mass-lumped midpoint finite element method with a structure-preserving solver for the Landau--Lifshitz--Gilbert equation with Dzyaloshinskii--Moriya interaction](https://arxiv.org/abs/2606.16142)
*Agus L. Soenjaya*
...
### [42] [Infinite-lattice discrete Calderón projection via the lattice Green's function for active noise shielding and confinement](https://arxiv.org/abs/2606.16192)
*Qing Xia*
...
### [43] [Topological spectral gap, multiscale Weyl's law, and homogenization in high-contrast PDEs](https://arxiv.org/abs/2606.16251)
...
### [44] [Isogeometric Analysis for Explicit Wave Propagation in Poroelastic Media](https://arxiv.org/abs/2606.16293)
...
### [45] [Geodesic Interpolation on the Grassmann Manifold: GLERP and Recursive GIDER Interpolants](https://arxiv.org/abs/2606.16463)
*Shingyu Leung*
...
### [46] [Petrov-Galerkin Variational Physics-Informed Neural Network Framework for Two-Dimensional Singularly Perturbed Problems](https://arxiv.org/abs/2606.16510)
...
### [47] [A geometric reformulation and structure-preserving rotational discrete gradient scheme for the full Ericksen-Leslie model](https://arxiv.org/abs/2606.16563)
...
### [48] [Nodal Representations for Kernel-Based Multilevel Interpolation](https://arxiv.org/abs/2606.16643)
...
### [49] [The effect of numerical integration in the FEM for elliptic problems with mixed boundary conditions](https://arxiv.org/abs/2606.16675)
*Juan Han,Haijun Wu*
...
### [50] [Geometric structure-preserving parametric finite element approximations for the constrained Helfrich flow](https://arxiv.org/abs/2606.16697)
...
### [51] [A variable-offset joint formulation for beams with arbitrary cross-sections using a null space method](https://arxiv.org/abs/2606.16755)
...
### [52] [PF-DIC: Phase field digital image correlation for integrated full-field displacement, strain, and damage measurements](https://arxiv.org/abs/2606.16850)
*Dingxiang Zhu,Ye Lu*
...
### [53] [Nitsche-based FEM for the Laplace eigenvalue problem: spectral approximation and a posteriori error analysis](https://arxiv.org/abs/2606.17052)
...
### [54] [A Reverse Hard-Core Model in $\mathbb{A}_2$: an Application of the Pirogov-Sinai Theory](https://arxiv.org/abs/2606.14903)
...
### [55] [Structure-Informed Neural Operators for Long-Time Prediction of Parametric Hamiltonian PDEs](https://arxiv.org/abs/2606.14913)
...
### [56] [Dynamic Doppler Effects on Dirac Spinor Fields](https://arxiv.org/abs/2606.14952)
...
### [57] [On the Non-Commutative Geometry of the Electroweak Interaction](https://arxiv.org/abs/2606.15039)
...
### [58] [The Standard Model Gauge Group from the Exceptional Jordan Algebra](https://arxiv.org/abs/2606.15235)
...
### [59] [Generalized symmetries, invariant solutions and conservation laws in the Jaynes-Cummings model](https://arxiv.org/abs/2606.15538)
...
### [60] [A High-Order Nyström Method for Coupled Boundary Integral Equations in Oblique-Incidence Scattering by Impedance Cylinders](https://arxiv.org/abs/2606.15616)
...
### [61] [Flowing to Normality and the Fate of the Single Ring Theorem](https://arxiv.org/abs/2606.15791)
...
### [62] [N-transform and factorization of the DN-map](https://arxiv.org/abs/2606.15895)
...
### [63] [A generalized Stieltjes system with polynomial source](https://arxiv.org/abs/2606.15916)
*D. Masoero,B. Shapiro*
...
### [64] [$q$-Deformed Topological Recursion, Weight Vectors and Algebraic Structures](https://arxiv.org/abs/2606.16441)
...
### [65] [Boundary monopole bubbling and Macdonald kernels for non-minuscule 't Hooft lines in $\mathcal N=4$ SYM](https://arxiv.org/abs/2606.16660)
*Ruiliang Li*
...
### [66] [The Algebra of Units: From Buckingham's Pi-grec Theorem to Latent-Variable Learning](https://arxiv.org/abs/2606.16737)
*Mauro Valorani*
...
### [67] [Self-Adjointness of the Standard Model of Non-Relativistic QED](https://arxiv.org/abs/2606.16947)
*Valentin Kußmaul*
