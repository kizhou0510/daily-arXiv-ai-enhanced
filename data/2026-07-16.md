...
### [10] [Boundary Thermalization in Superdiffusive Energy Transport](https://arxiv.org/abs/2607.13229)
...
### [11] [Spectral Analysis and Liouville-Green Asymptotics for a Radial Sturm-Liouville Operator with Variable Coefficients](https://arxiv.org/abs/2607.13349)
...
### [12] [Perturbative algebraic quantum field theory with smoothened boundary](https://arxiv.org/abs/2607.13765)
...
### [13] [A Geometric Derivation of the Einstein Equations from the Causal Action Principle](https://arxiv.org/abs/2607.13871)
...
### [14] [Log-Sobolev inequalities for boundary-driven anharmonic chains](https://arxiv.org/abs/2607.13953)
*Jianfeng Lu*
...
### [15] [When is the combined load identifiable from a stress-intensity profile? A coupled forward-inverse study on SIFBench finite-element data](https://arxiv.org/abs/2607.13074)
...
### [16] [Tensor-Network Finite Elements for Analytic Operator Equations](https://arxiv.org/abs/2607.13129)
...
### [17] [A Generative Model-Free Form Deformation Approach for the Generation of Mesh Motions with Applications to PDE](https://arxiv.org/abs/2607.13202)
...
### [18] [Gaussian FSBP operators: Comparison and application to numerical methods for hyperbolic conservation laws](https://arxiv.org/abs/2607.13224)
...
### [19] [A linear, fully decoupled, and unconditionally energy-stable SAV-FEM for the Cahn--Hilliard--Navier--Stokes model](https://arxiv.org/abs/2607.13253)
...
### [20] [Duality Framework for Flux Constrained Flow in Porous Media: Analysis and Numerics](https://arxiv.org/abs/2607.13256)
...
### [21] [A Weighted Integral-Regularized Finite Difference Scheme for the Tempered Fractional Laplacian](https://arxiv.org/abs/2607.13317)
...
### [22] [Data driven non-equilibrium moist phase exchanges for atmospheric convection within a discontinuous Galerkin model of the compressible Euler equations](https://arxiv.org/abs/2607.13360)
...
### [23] [Hybrid GKB Methods for X-Ray Tomography Problems with Unmatched Back Projector](https://arxiv.org/abs/2607.13381)
...
### [24] [Residual-Christoffel Sampling for Random Feature Collocation of Linear PDEs](https://arxiv.org/abs/2607.13382)
...
### [25] [Inverse scattering for three-dimensional random obstacles with multi-frequency data](https://arxiv.org/abs/2607.13473)
*Zhiqi Sun,Yiwen Lin*
...
### [26] [Reconstruct the ambient noise source from the multi-frequency sparse correlation data](https://arxiv.org/abs/2607.13509)
...
### [27] [Computing Strong Rank-Revealing Factorizations for Matrices with Orthonormal Rows](https://arxiv.org/abs/2607.13532)
*Anil Damle*
...
### [28] [A Spectrally Damped Tensor Randomized Kaczmarz Method for Doubly Noisy Tensor Systems](https://arxiv.org/abs/2607.13552)
...
### [29] [Spectral-Informed Neural Networks Outperform Spectral Methods in High-dimensional PDEs](https://arxiv.org/abs/2607.13566)
...
### [30] [Approximation of solutions of parameter-dependent problems by residual neural networks](https://arxiv.org/abs/2607.13574)
*Ana Carpio*
...
### [31] [Adaptive space-time BEM for the heat equation with Neumann boundary conditions](https://arxiv.org/abs/2607.13578)
...
### [32] [Error Analysis of a Fully-Discrete Implicit $θ$-Scheme with WG-FEM for Parabolic Singularly Perturbed Boundary Turning Point Problems](https://arxiv.org/abs/2607.13611)
...
### [33] [Revisiting column subset selection through the lens of submodularity](https://arxiv.org/abs/2607.13823)
...
### [34] [An Order-One Lower Bound on the Error of Scalable Generalized Multiscale Finite Element Space Constructions](https://arxiv.org/abs/2607.13888)
*Changqing Ye*
...
### [35] [Adaptivity in Local Kernel Based Methods for Approximating Solutions to the Poisson Equation](https://arxiv.org/abs/2607.14057)
