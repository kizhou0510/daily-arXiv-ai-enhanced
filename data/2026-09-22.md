...
### [21] [An Implementation-Friendly SDG Scheme based on Cartesian Grids for Stokes Equations with Pressure Robustness and Superconvergence](https://arxiv.org/abs/2609.24232)
...
### [22] [Time-uniform accuracy of ensemble Kalman filters with localization](https://arxiv.org/abs/2609.23927)
...
### [24] [Cost-Accuracy Trade-offs: Neural Operator vs Classical Numerical Solver](https://arxiv.org/abs/2609.24021)
...
### [25] [Accurate wall shear stress in immersed flow analysis with application to point cloud-based CFD](https://arxiv.org/abs/2609.24069)
...
### [26] [A mesh- and horizon-robust preconditioner for finite element discretizations of volume-constrained nonlocal diffusion problems](https://arxiv.org/abs/2609.24143)
...
### [27] [A Discretely Entropy Conserving/Stable Flux Reconstruction Scheme via Hybridized Split Form Differential Operator and Generalized Entropy Projection](https://arxiv.org/abs/2609.24257)
...
### [41] [AWE: Adaptive Weight Encoding for Exact Integer Matrix Products with Fewer GEMMs on FP4 Tensor Cores](https://arxiv.org/abs/2609.24519)
...
### [42] [Vanadium doping induced valley asymmetries in WS$_2$ monolayers](https://arxiv.org/abs/2609.22580)
...
### [43] [Electrical Probing of Dark Excitons through Microwave Permittivity](https://arxiv.org/abs/2609.22710)
...
### [44] [Non-Hermitian Topology from Edge Transport in Hermitian Quantum Anomalous Hall Systems](https://arxiv.org/abs/2609.23099)
...
### [45] [Magnetic Quadrupole Lens and Current-Induced Quadrupolar Dynamics of Antiskyrmion](https://arxiv.org/abs/2609.23129)
...
### [46] [Collective depinning of dipolar skyrmion chains: thermal and athermal rounding of an elastic polymer in a quenched landscape](https://arxiv.org/abs/2609.23181)
...
### [47] [Non-Markovian Quantum Dynamics of Exciton-Polaritons](https://arxiv.org/abs/2609.23295)
...
### [48] [Non-Hermitian Quantum Mechanics I: Instantaneous Self-Energy](https://arxiv.org/abs/2609.23426)
...
### [49] [Sub-Thermionic Switching in a Negative-Capacitance Bandgap-Change Field-Effect Transistor](https://arxiv.org/abs/2609.23505)
...
### [50] [Universal Generalized Brillouin Zone Theory I: Review of the Spectral Approach](https://arxiv.org/abs/2609.23523)
...
### [51] [Multiscale Modeling of Ion Transport in Nanopores: Fitting Implicit-Water Radial Diffusion Profiles to Explicit-Water Molecular Dynamics](https://arxiv.org/abs/2609.23575)
...
### [52] [Interplay of spin-orbit coupling and magnetic chirality: Multidirectional spin polarization in a helical antiferromagnet](https://arxiv.org/abs/2609.23618)
...
### [53] [Scalable Multiple Electron Transport Architectures for Feedback Traceable Current Sources](https://arxiv.org/abs/2609.24015)
...
### [54] [The Superconducting Talbot Effect in Phased-Array Josephson Junctions](https://arxiv.org/abs/2609.24572)
...
### [55] [Corbino-Enhanced Supersonic Acoustic-Emission Threshold in a GaAs Two-Dimensional Electron System](https://arxiv.org/abs/2609.24585)
...
### [56] [Observation of Kondo Effect in Rhombohedral Graphene Superlattices](https://arxiv.org/abs/2609.24734)
...
### [57] [Modified Low-Temperature Scanning Tunneling Microscope for Ultrafast Pump-Probe Spectroscopy](https://arxiv.org/abs/2609.24916)
...
### [58] [Model of the magnon Kerr effect in a highly anisotropic ferromagnet](https://arxiv.org/abs/2609.24959)
...
### [59] [Collective Coordinate Dynamics of Antiferromagnet: Gravity by Quantum Metric](https://arxiv.org/abs/2609.24975)
...
### [60] [Cohomology of $\mathfrak{psl}(n|n)$ in trivial and in adjoint representations](https://arxiv.org/abs/2609.22598)
...
### [61] [Distributional Fractional Taylor Series and Interpretation of the Fractal and Number-Theoretic Explicit Formulas](https://arxiv.org/abs/2609.22759)
...
### [62] [Holomorphic Conformal Cartan Geometry: Conformal Gravity, Twistors, and Ambitwistors](https://arxiv.org/abs/2609.22861)
*Chen-Hsu Chien*
...
### [63] [Higher-order and non-geometric symmetries and Noether's theorem in k-cosymplectic Hamiltonian field theory](https://arxiv.org/abs/2609.23034)
...
### [64] [Long time stability of low--frequency packets of modes at finite total energy](https://arxiv.org/abs/2609.23119)
...
### [65] [Six-wave scattering in Hamiltonian Dysthe equations: Euler matching and integrability obstructions](https://arxiv.org/abs/2609.23175)
...
### [66] [Routing and memory in the three-dimensional mirror model on K-lattice](https://arxiv.org/abs/2609.23244)
...
### [67] [Resurgence and Complex Geodesics for the Heisenberg Heat Kernel](https://arxiv.org/abs/2609.23608)
*Xinxing Tang*
...
### [68] [Local conservation laws and symmetries of three-dimensional incompressible Euler flow](https://arxiv.org/abs/2609.23772)
*Alexey Shevyakov*
...
### [69] [Sum of Three Squares and Particle in a Cubic Box - Degeneracies](https://arxiv.org/abs/2609.23794)
*S. Pratik Khastgir*
...
### [70] [Quantum modularity in refined topological recursion](https://arxiv.org/abs/2609.23864)
...
### [71] [Recursive construction of spectral basis and its application to matrices](https://arxiv.org/abs/2609.24418)
*A. Acus,A. Dargys*
...
### [72] [The Hadamard parametrix on globally hyperbolic spacetimes with Robin boundary conditions: Fundamental solutions and Hadamard states](https://arxiv.org/abs/2609.24465)
...
### [73] [Payoffs and perception mediate environmental feedback in an N-player trust game with Q-learning](https://arxiv.org/abs/2609.24493)
...
### [74] [Proactive Incentive Regulation in Multi-Agent Systems with Environmental Feedback](https://arxiv.org/abs/2609.24506)
...
### [75] [Batalin-Vilkovisky algebras from Ševera bicomplexes](https://arxiv.org/abs/2609.24781)
...
### [76] [Constraints for Physical Gauge Groups Coming from the Causal Action Principle](https://arxiv.org/abs/2609.24888)
...
### [77] [Don't mind the gap: Absolutely Continuous Edge Spectrum in a Mobility Gap](https://arxiv.org/abs/2609.25000)
